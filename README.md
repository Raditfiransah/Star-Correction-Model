...
Multi-task learning pipeline that simultaneously predicts **sentiment** (Positive / Neutral / Negative) and **corrected star rating** (1–5) from Indonesian review text, using a shared BERT encoder with two independent classification heads.
